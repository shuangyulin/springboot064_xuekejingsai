    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="专业简介" prop="zhuanyejianjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="专业简介"
                  v-model="ruleForm.zhuanyejianjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuanyejianjie" label="专业简介" prop="zhuanyejianjie">
                    <span>{{ruleForm.zhuanyejianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>

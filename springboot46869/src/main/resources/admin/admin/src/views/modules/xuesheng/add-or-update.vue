<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="参与竞赛" prop="canyujingsai">
          <el-select v-model="ruleForm.canyujingsai" placeholder="请选择参与竞赛">
            <el-option
                v-for="(item,index) in canyujingsaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="参与竞赛" prop="canyujingsai">
	      <el-input v-model="ruleForm.canyujingsai"
                placeholder="参与竞赛" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueyuan = true;
          ...
          if(o=='canyujingsai'){
            this.ruleForm.canyujingsai = obj[o];
	    this.ro.canyujingsai = true;
            continue;
          }
          if(o=='shouji'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.canyujingsaiOptions = "是,否".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({

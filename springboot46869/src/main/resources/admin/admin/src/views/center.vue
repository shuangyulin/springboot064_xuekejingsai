<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="账号" prop="zhanghao">
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='xuesheng'"  label="参与竞赛" prop="canyujingsai">
          <el-select v-model="ruleForm.canyujingsai" placeholder="请选择参与竞赛">
            <el-option
                v-for="(item,index) in xueshengcanyujingsaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='lingduijiaoshi'"  label="账号" prop="zhanghao">
          <el-input v-model="ruleForm.zhanghao" readonly              placeholder="账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='lingduijiaoshi'"  label="姓名" prop="xingming">
          <el-input v-model="ruleForm.xingming"               placeholder="姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='lingduijiaoshi'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
                v-for="(item,index) in lingduijiaoshixingbieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='lingduijiaoshi'"  label="教工号" prop="jiaogonghao">
          <el-input v-model="ruleForm.jiaogonghao"               placeholder="教工号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='lingduijiaoshi'"  label="学院" prop="xueyuan">
          <el-select v-model="ruleForm.xueyuan" placeholder="请选择学院">
            <el-option
                v-for="(item,index) in lingduijiaoshixueyuanOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='lingduijiaoshi'"  label="专业领域" prop="zhuanyelingyu">
          <el-input v-model="ruleForm.zhuanyelingyu"               placeholder="专业领域" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='lingduijiaoshi'"  label="手机" prop="shouji">
          <el-input v-model="ruleForm.shouji"               placeholder="手机" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='lingduijiaoshi'"  label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang"               placeholder="邮箱" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='lingduijiaoshi'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.touxiang?ruleForm.touxiang:''"
          @change="lingduijiaoshitouxiangUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
...
export default {
  data() {
    return {
      ...
      xueshengcanyujingsaiOptions: [],
      lingduijiaoshixingbieOptions: [],
      lingduijiaoshixueyuanOptions: [],
    };
  },
  mounted() {
    ...
    this.xueshengcanyujingsaiOptions = "是,否".split(',')
    this.lingduijiaoshixingbieOptions = "男,女".split(',')
    this.$http({
      url: `option/xueyuan/xueyuan`,
      method: "get"
    }).then(({ data }) => {
      if (data && data.code === 0) {
        this.lingduijiaoshixueyuanOptions = data.data;
      } else {
        this.$message.error(data.msg);
      }
    });
  ...
  methods: {
    ...
    lingduijiaoshitouxiangUploadChange(fileUrls) {
        this.ruleForm.touxiang = fileUrls;
    },
    onUpdateHandler() {
      if((!this.ruleForm.zhanghao)&& 'jiaoshi'==this.flag){
      ...
      if((!this.ruleForm.zhanghao)&& 'lingduijiaoshi'==this.flag){
        this.$message.error('账号不能为空');
        return
      }
      if((!this.ruleForm.mima)&& 'lingduijiaoshi'==this.flag){
        this.$message.error('密码不能为空');
        return
      }
      if( 'lingduijiaoshi' ==this.flag && this.ruleForm.shouji&&(!isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
      if( 'lingduijiaoshi' ==this.flag && this.ruleForm.youxiang&&(!isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮箱格式`);
        return
      }
